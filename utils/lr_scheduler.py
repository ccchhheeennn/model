...
class LRScheduler(object):
    ...
    def __init__(self, mode, base_lr=0.045, target_lr=0, niters=0, nepochs=0, iters_per_epoch=0,
                 offset=0, power=9, step_iter=None, step_epoch=None, step_factor=0.1):
...
if __name__ == '__main__':
    lr_scheduler = LRScheduler(mode='poly', base_lr=0.045, nepochs=60,
