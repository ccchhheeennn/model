...
def test(args, test_loader, model):
    ...
    for i, (input, label, size, name) in enumerate(test_loader):
        ...
        total_fps = total_fps + 1 / time_taken
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', type=str,
                        default="/mnt/Fast_SCNN/checkpoint/cityscapes/DABNetbs8gpu1_train/model_1000.pth",
                        help="use the file to load the checkpoint for evaluating or testing ")
    parser.add_argument('--save_seg_dir', type=str, default="/mnt/Fast_SCNN/result/",
